  ...
  render() {
    return (
      <div className="AddTaskAdd">
        ...
        <select className="ATAFIO ATAEl" onChange={this.FIOhandler}>
          {this.genFIOSelect()}
        </select>

        <p className="ATAWHERELab ATALab">WHERE</p>
        <select className="ATAWHERE ATAEl" onChange={this.WHERhandler}>
          {this.genUnitSelect()}
        </select>
        ...
        <button className="ATABut" onClick={this.BUThandler}>
          Add task
        </button>
      </div>
    );
